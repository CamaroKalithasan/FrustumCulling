...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:
		...
		break;
	case WM_MOUSEMOVE:
		currentPosX = GET_X_LPARAM(lParam);
		currentPosY = GET_Y_LPARAM(lParam);
		break;
	default:
...
MSG begin_main_loop()
{
	...
	while (true)
	{
		...
		{
			dev_app.update();
			renderer.default_view.view_mat = dev_app.UpdateCamera(renderer.default_view.view_mat, currentPosX - prevPosX, currentPosY - prevPosY);
